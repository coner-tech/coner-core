...
import org.axrunner.api.request.AddEventRequest;
...
public class CreateEventIntegrationTest {
    ...
    @ClassRule
    public static final DropwizardAppRule<AxRunnerDropwizardConfiguration> RULE = IntegrationTestUtils.buildAppRule();
