...
public class EventBoundaryTest {
    ...
    public void whenMergeApiIntoDomainItShouldMerge() {
        org.axrunner.api.entity.Event apiEvent = fullApiEvent();
    ...
    public void whenMergeDomainIntoApiItShouldMerge() {
        ...
        org.axrunner.api.entity.Event apiEvent = new org.axrunner.api.entity.Event();
    ...
    public void whenMergeDomainIntoHibernateItShouldMerge() {
        Event domainEvent = fullDomainEvent();
        org.axrunner.hibernate.entity.Event hibernateEvent = new org.axrunner.hibernate.entity.Event();
    ...
    public void whenMergeHibernateIntoDomainItShouldMerge() {
        org.axrunner.hibernate.entity.Event hibernateEvent = fullHibernateEvent();
        Event domainEvent = new Event();
    ...
    private org.axrunner.api.entity.Event fullApiEvent() {
        org.axrunner.api.entity.Event apiEvent = new org.axrunner.api.entity.Event();
        apiEvent.setId(id);
    ...
    private org.axrunner.hibernate.entity.Event fullHibernateEvent() {
        org.axrunner.hibernate.entity.Event hibernateEvent = new org.axrunner.hibernate.entity.Event();
